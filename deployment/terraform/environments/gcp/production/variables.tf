# -----------------------------------------------------------------------------
# PipesHub AI - GCP Production Environment Variables
# -----------------------------------------------------------------------------
...
variable "mongodb_instance_tier" {
  description = "Instance tier for MongoDB Atlas"
  type        = string
  default     = "M30"
}
...
variable "kv_store_type" {
  description = "Key-value store type (etcd or redis)"
  type        = string
  default     = "etcd"
}

variable "data_store" {
  description = "Graph/document data store type (arangodb or neo4j)"
  type        = string
  default     = "arangodb"
}
